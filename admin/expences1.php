  ...
  function display_expence() {
      $.ajax({
          ...
          for (var i = 0; i < count; i++) {
              ...
              $('#loadtabledata').append('<tr><td class="text-center">' + (i + 1) + '</td><td class="text-center">' + response[i]['expence_date'] + '</td><td class="text-center"><button type="button" class="btn btn-link" title="Edit Expence" data-toggle="collapse" style="font-size:15px; padding: 0px;color:#468ebb"   name="submit" onclick="updateexpence(' + expence_id + ');">' + response[i]['expence_category'] + '</button></td><td class="text-center">' + response[i]['expence_merchant'] + '</td><td class="text-center">' + response[i]['expence_status'] + '</td><td class="text-center">' + response[i]['expence_amount'] + '</td><td class="text-center"><div class="btn-group"><button type="button" class="btn btn-success" name="submit"  title="Upload Bill Receipts" data-toggle="collapse" onClick="uploadBillReceipt(' + expence_id + ');"><i class="fa fa-upload"></i></button><button type="button" class="btn btn-warning" name="submit"  title="View Bill Receipts" data-toggle="collapse" onClick="viewexpencereceipt(' + expence_id + ');"><i  class="fa fa-eye"></i></button><button type="button" class="btn btn-primary" data-toggle="collapse"  name="submit"  title="Edit Expence" onclick="updateexpence(' + expence_id + ');"><i class="fa fa-edit"></i></button><button type="button" title="Remove Expence" class="btn btn-danger" name="submit"  onClick="removeexpence(' + expence_id + ');"><i class="fa fa-trash"></i></button></div></td></tr>');
