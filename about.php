...
<head>
    ...
    <title>Spica Global Arts &mdash;About Us</title>
  ...
  <body>
    <?php include 'navbar.php';?>
      <section class="probootstrap-hero probootstrap-hero-inner" style="background-image: url(img/demo.jpg)"  data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
